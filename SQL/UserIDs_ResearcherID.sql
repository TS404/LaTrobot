# Collects ResearcherIDs from symprptprd

SELECT DISTINCT
    U.[ID] AS 'User ID',
    U.[Computed Name Alphabetical],
    UIS.[Name],
    CASE WHEN UI.[Identifier Scheme ID] = 8 THEN UI.[Identifier Value] END AS 'ResearcherID',
...
WHERE UI.[Is Claimed] = 1 AND UI.[Identifier Scheme ID] = 8